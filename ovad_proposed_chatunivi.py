...
def main():
    ...
    parser.add_argument('--model_path', default='Chat-UniVi/weights/chatunivi', type=str)
    ...
    # configure file
    predict_file_name = f'results/{cfg.dataset_name}/chatunivi_ovad_{cfg.dataset_name}_{cfg.prompt_type}.json'
    ...
    if cfg.calc_auc:
        ...
        graph_path = f'results/{cfg.dataset_name}/{cfg.type}/{cfg.prompt_type}/chatunivi_ovad_org_{cfg.dataset_name}_{cfg.type}_{cfg.prompt_type}.jpg'
        ...
        print('-----------------------------------')
        anomalies_idx = [i for i,l in enumerate(labels) if l==1] 
        graph_path = f'results/{cfg.dataset_name}/{cfg.type}/{cfg.prompt_type}/chatunivi_ovad_combi_{cfg.dataset_name}_{cfg.type}_{cfg.prompt_type}.jpg'
    ...
    if cfg.calc_video_auc:
        ...
        for i in progress_bar(range(len(label_arr)), total=len(label_arr)):
            ...
            graph_path = f'results/{cfg.dataset_name}/{cfg.type}/{cfg.prompt_type}/videos/chatunivi_ovad_combi_{cfg.dataset_name}_{video_name}_{cfg.type}_{cfg.prompt_type}.jpg'
