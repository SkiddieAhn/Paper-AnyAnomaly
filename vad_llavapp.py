...
def main():
    ...
    # configure file
    predict_file_name = f'results/{cfg.dataset_name}/{cfg.type}/{cfg.prompt_type}/llavapp_{cfg.dataset_name}_{cfg.type}_{cfg.prompt_type}.json'
    ...
    if cfg.calc_auc:
        ...
        graph_path = f'results/{cfg.dataset_name}/{cfg.type}/{cfg.prompt_type}/llavapp_{cfg.dataset_name}_{cfg.type}_{cfg.prompt_type}.jpg'
    ...
    if cfg.calc_video_auc:
        ...
        for i in progress_bar(range(len(gt_arr)), total=len(gt_arr)):
            ...
            graph_path = f'results/{cfg.dataset_name}/{cfg.type}/{cfg.prompt_type}/videos/llavapp_{cfg.dataset_name}_{video_name}_{cfg.type}_{cfg.prompt_type}.jpg'
