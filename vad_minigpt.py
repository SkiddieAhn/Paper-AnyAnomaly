...
def main():
    ...
    # configure file
    predict_file_name = f'results/{cfg.dataset_name}/{cfg.type}/{cfg.prompt_type}/minigpt_{cfg.dataset_name}_{cfg.type}_{cfg.prompt_type}.json'
            ...
            for i, video_path in progress_bar(enumerate(video_paths), total=len(video_paths)):
                ...
                for fr in frame_loader:
                    ...
                    for keyword in keyword_list:
                        ...
                        response = lvlm_test(model, vis_processor, instruction, fr)
    ...
    if cfg.calc_auc:
        ...
        graph_path = f'results/{cfg.dataset_name}/{cfg.type}/{cfg.prompt_type}/minigpt_{cfg.dataset_name}_{cfg.type}_{cfg.prompt_type}.jpg'
    ...
    if cfg.calc_video_auc:
        ...
        for i in progress_bar(range(len(gt_arr)), total=len(gt_arr)):
            ...
            graph_path = f'results/{cfg.dataset_name}/{cfg.type}/{cfg.prompt_type}/videos/minigpt_{cfg.dataset_name}_{video_name}_{cfg.type}_{cfg.prompt_type}.jpg'
